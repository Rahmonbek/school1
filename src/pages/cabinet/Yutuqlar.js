          ...
          <Row>
            <Col style={{ marginTop: '20px' }} lg={6} md={6} sm={12}>
              <div className='card'>
                ...
                <div className={style.cardBody}>
                  <h3>
                    Yuksak ma'naviyatli avlod <img src={gold} />
                  </h3>
                  <p>1-o'rin</p>
                  <p>
                    Yuksak ma'naviyatli avlod tanlovida bizning maktabimiz
                    guruhi birinchi o'rinni egalladi
                  </p>
                </div>
              </div>
            </Col>
            ...
            <Col style={{ marginTop: '20px' }} lg={6} md={6} sm={12}>
              <div className='card'>
                ...
                <div className={style.cardBody}>
                  <h3>
                    Yosh sportchilar <img src={gold} />
                  </h3>
                  <p>1-o'rin</p>
                  <p>
                    Yosh sportchilar ko'rik tanlovida gimnastika bo'yicha
                    Rustamova Dilnoza 1-o'rinni egalladi
                  </p>
                </div>
              </div>
            </Col>
